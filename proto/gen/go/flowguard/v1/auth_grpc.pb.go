...
const (
	Auth_Login_FullMethodName            = "/flowguard.v1.Auth/Login"
	Auth_RefreshToken_FullMethodName     = "/flowguard.v1.Auth/RefreshToken"
	Auth_ValidateToken_FullMethodName    = "/flowguard.v1.Auth/ValidateToken"
	Auth_GetJWKS_FullMethodName          = "/flowguard.v1.Auth/GetJWKS"
	Auth_IssueServiceCert_FullMethodName = "/flowguard.v1.Auth/IssueServiceCert"
)
...
type AuthClient interface {
	...
	IssueServiceCert(ctx context.Context, in *IssueServiceCertRequest, opts ...grpc.CallOption) (*ServiceCert, error)
}
...
func (c *authClient) IssueServiceCert(ctx context.Context, in *IssueServiceCertRequest, opts ...grpc.CallOption) (*ServiceCert, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceCert)
	err := c.cc.Invoke(ctx, Auth_IssueServiceCert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	IssueServiceCert(context.Context, *IssueServiceCertRequest) (*ServiceCert, error)
...
func (UnimplementedAuthServer) IssueServiceCert(context.Context, *IssueServiceCertRequest) (*ServiceCert, error) {
	return nil, status.Error(codes.Unimplemented, "method IssueServiceCert not implemented")
}
...
func _Auth_IssueServiceCert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IssueServiceCertRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).IssueServiceCert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_IssueServiceCert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).IssueServiceCert(ctx, req.(*IssueServiceCertRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IssueServiceCert",
			Handler:    _Auth_IssueServiceCert_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "flowguard/v1/auth.proto",
}
